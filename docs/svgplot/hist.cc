...
int main(int argc, char** argv) {
	{ // Example 1
        ...
        plt.hist(samples);
        plt.savefig("../docs/svgplot/hist/example1.svg");
	}
    ...
    { // Example 6
        ...
        plt.savefig("../docs/svgplot/hist/example6.svg");
	}
	...
	{ // Example 7
        ...
        plt.savefig("../docs/svgplot/hist/example7.svg");
	}
	...
	{ // Example 8
        ...
        plt.savefig("../docs/svgplot/hist/example8.svg");
	}
